...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/main.scss */ \"./src/styles/main.scss\");\n/* harmony import */ var _render_renderCalendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render/renderCalendar */ \"./src/js/render/renderCalendar.js\");\n/* harmony import */ var _render_toogle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./render/toogle */ \"./src/js/render/toogle.js\");\n // eslint-disable-next-line no-unused-vars\n\n // eslint-disable-next-line no-unused-vars\n// eslint-disable-next-line no-unused-vars\n\n\n_render_renderCalendar__WEBPACK_IMPORTED_MODULE_1__.default.render();\n_render_renderCalendar__WEBPACK_IMPORTED_MODULE_1__.default.filter();\n\n//# sourceURL=webpack://meet_calendar/./src/js/index.js?");
...
/***/ "./src/js/render/toogle.js":
/*!*********************************!*\
  !*** ./src/js/render/toogle.js ***!
  \*********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"toogle\": () => /* binding */ toogle,\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _render_renderCalendar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render/renderCalendar */ \"./src/js/render/renderCalendar.js\");\n/* eslint-disable guard-for-in */\n\nvar allTable = document.getElementById('table');\nvar el = document.querySelector('.popup');\nvar popupTitle = document.querySelector('.popup__title');\nvar popupYes = document.querySelector('.popup__btn--yes');\nvar popupNo = document.querySelector('.popup__btn--no');\nfunction toogle() {\n  el.style.display = el.style.display === 'none' ? 'flex' : 'none';\n}\npopupNo.addEventListener('click', function () {\n  toogle();\n});\npopupYes.addEventListener('click', function () {\n  toogle();\n}); // eslint-disable-next-line func-names\n\nallTable.onclick = function (event) {\n  var target = event.target;\n\n  if (target.textContent !== '') {\n    toogle();\n    popupTitle.innerHTML = \"Are you sure you want delete \".concat(event.target.textContent, \" ?\");\n  }\n\n  popupYes.addEventListener('click', function () {\n    var data = JSON.parse(localStorage.getItem('data'));\n    Object.entries(data.data).map(function (item) {\n      return item[1].filter(function (val) {\n        return val.id === event.target.id ? _render_renderCalendar__WEBPACK_IMPORTED_MODULE_0__.default.remove(val.id) : console.log('null');\n      });\n    });\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (toogle());\n\n//# sourceURL=webpack://meet_calendar/./src/js/render/toogle.js?");
